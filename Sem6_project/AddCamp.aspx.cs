    ...
    public partial class AddCamp : System.Web.UI.Page
    {
        ...
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd = new SqlCommand("insert into camp values(@name,@date,@time,@add,@city,@image,@cont)", con);
                ...
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alert", "alert ('Camp Added Successfully...!!!');window,location='AddCamp.aspx';", true);
            }
            catch (Exception ae)
            {
