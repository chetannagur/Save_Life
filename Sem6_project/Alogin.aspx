<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Alogin.aspx.cs" Inherits="Sem6_project.Alogin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Admin Log In
</asp:Content>
...
<div class="s1" 
        ...
        style="  text-align: center; background-image: url('boostrap/pngtree-geometric-gradient-creative-blood-donation-poster-background-material-image_134137.jpg');">
            <img src="boostrap/Login_Panel_Image.png" class="animated fadeInRightBig" alt="" />
        </div>
        <div class="container1" style=" text-align: center;">
            <div class="inner animated fadeInLeft">
                <asp:Label ID="Label1" runat="server" Text="Admin Log-In" Font-Bold="True" 
                ...
                <br />
                <br />
                <asp:Button ID="Button1" CssClass="btn" ForeColor= "White" BorderStyle="Ridge" runat="server" Text="Log In" Font-Bold="True" 
