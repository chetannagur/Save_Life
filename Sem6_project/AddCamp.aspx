<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddCamp.aspx.cs" Inherits="Sem6_project.AddCamp" %>
...
<h1 class="style6"><strong>Add Camp</strong></h1>
         Camp Name:-
       ...
       Address:-
        ...
        onclick="btnsubmit_Click" BorderStyle="Ridge" CssClass="btn_style" />
    &nbsp;&nbsp;&nbsp;
