<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Contactus2.aspx.cs" Inherits="Sem6_project.Contactus2" %>
...
<br />
    <asp:Button  ID="Button1" runat="server" Text="Contact" 
        onclick="Button1_Click" CssClass="btn_style bt1" ForeColor="White" />
</div>
</div>
<div class="d3">
<div>
...
<div >
    ...
    <br />
        <asp:Button class="bt1" ID="btnsubmit" runat="server" Text="Submit" 
            onclick="btnsubmit_Click" BorderStyle="Ridge" CssClass="btn_style" ForeColor="White" />
    </asp:Panel>
</div>
<div 
    
      style="visibility: visible;  height: 25px; text-align: center; width: 100%; font-weight: 700; color: #0000FF; background-color: #FF3300; bottom:0px; " >
